package com.kettle.mykettle.utils;
...
public class RSAUtil {
     ...
     * @return
     */
    public static String encryptWithPrivateKey(String privateKey, String content) throws Exception {
        //base64编码的私钥
        byte[] decoded = Base64.decodeBase64(privateKey);
        ...
        String s = Base64.encodeBase64String(cipher.doFinal(content.getBytes("UTF-8")));
        return s;
     ...
     * @throws Exception
     */
    public static String decryptWithPublicKey(String publicKey, String content) throws Exception {
